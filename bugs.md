...
- **[FIXED] OpenRouter Free Fallback Models**: Updated `OPENROUTER_FALLBACK_MODELS` in `app/services/llm_clients.py` with active free endpoints (`llama-3.3-70b-instruct:free`, `llama-3.2-3b-instruct:free`, `gemini-2.0-flash-exp:free`, `deepseek-r1:free`, `qwen-2.5-coder-32b-instruct:free`) and verified automatic failover to `groq_chat`.
